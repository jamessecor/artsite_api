            ...
            <div>
                <nav className="navbar navbar-expand-lg py-3 navbar-light">
                    <div className="container-fluid">
                        <a data-page-id="home" className="navbar-brand" href="" onClick={this.handleClick}>James Secor</a>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className={`dropdown-menu ${this.state.isArtworkDropdownOpen ? 'show' : ''}`}
                                        ...
                                        {[...Array(currentYear - firstArtworkYear + 1).keys()].map((i) => {
                                            return (
                                                <li key={currentYear - i}><a data-page-id="artwork" data-filter={currentYear - i} onClick={this.handleClick} className="dropdown-item" href="#">{currentYear - i}</a></li>
                                            );
                                        })}
                                    </ul>
                                </li>
                                <li className="nav-item">
                                    <a href="" data-page-id="cv" className={this.state.currentPage == "cv" ? "nav-link active" : "nav-link"}
                            ...
                            <ul className="nav navbar-nav navbar-right ms-auto d-flex align-items-center">
                                ...
                                <li>
                                    <form onSubmit={this.handleSearchSubmit} className="d-flex">
                                        <input onChange={this.handleSearchChange} className="form-control me-2" type="search" placeholder="Search"
                                               aria-label="Search" />
